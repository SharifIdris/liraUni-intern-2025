...
import { Bell, Check, X, User, MessageSquare, FileText, Clock } from 'lucide-react';
...
interface Notification {
  id: string;
  type: 'activity_submitted' | 'activity_reviewed' | 'new_message' | 'profile_updated' | 'channel_created';
  title: string;
  message: string;
  read: boolean;
  created_at: string;
